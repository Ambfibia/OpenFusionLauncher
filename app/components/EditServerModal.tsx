...
export default function EditServerModal({
  ...
  const makeNewServerDetails = () => {
    ...
    const desc = descTrimmed == "" ? t("server.openfusion") : descTrimmed;
        ...
        <Form>
          <Form.Group className="mb-4 px-3" controlId="editServerDescription">
            ...
            <Form.Control
              ...
              placeholder={t("server.openfusion")}
            />
          </Form.Group>
          <Tabs
            activeKey={tab}
          ...
          >
            ...
            <Tab eventKey={TAB_ENDPOINT} title={t("server.endpoint")}>
              <Form.Group className="mb-3 px-3" controlId="editServerEndpoint">
                <Form.Label>{t("common.apiHost")}</Form.Label>
                <Form.Control
                  type="text"
                  value={endpoint}
                  onChange={(e) => setEndpoint(e.target.value)}
                  placeholder={"server.apimyserverxyz"}
